...
const AllApplications = () => {
	...
	const handleSearchBar = (event: React.ChangeEvent<HTMLInputElement>) => {
		...
		const filteredData = data?.data.filter((item: ReturnType | null) => {
			return (
				//@ts-ignore
	...
	return (
		<div>
			<ActionContainer title="All Applications" onChange={handleSearchBar}>
				<>
					{isLoading ? (
						<IsLoadingData />
					) : (
...
export default withQueryClient(AllApplications);
